...
ALTER TABLE tk_basdat_a02.PERIODE_PENERIMAAN ADD COLUMN status_aktif BOOLEAN;

    UPDATE PERIODE_PENERIMAAN SET status_aktif=FALSE WHERE nomor=2 AND tahun='2012';
    UPDATE PERIODE_PENERIMAAN SET status_aktif=FALSE WHERE nomor=3 AND tahun='2013';
    UPDATE PERIODE_PENERIMAAN SET status_aktif=TRUE WHERE nomor=4 AND tahun='2014';
