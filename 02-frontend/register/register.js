...
function onRegister() {
  ...
  if (validateForm(data)) {
    ...
    setTimeout(function() {
      // onRegisterSuccess();
      onRegisterFailed('Username/Password tidak cocok');
    }, 1000);
  }
}
...
function onRegisterSuccess() {
  swal('Success!', 'Berhasil mendaftar sebagai pelamar!', 'success');
  // login
  // window.location = '/'
}

function onRegisterFailed(error) {
  swal('Failed!', 'Gagal mendaftar: ' + error, 'error');
